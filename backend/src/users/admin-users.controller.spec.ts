...
describe('AdminUsersController', () => {
  ...
  it('updateRole deleguje id i rolę', async () => {
    await ctrl.updateRole(2, { role: UserRole.MANAGER } as any);
    expect(svc.updateRole).toHaveBeenCalledWith(2, UserRole.MANAGER);
  });
});
